...
const itemToDelete = ref<MotherBrand | null>(null)

const items = computed(() => motherBrandStore.items)
const isLoading = computed(() => motherBrandStore.isLoading)
const totalRecords = computed(() => motherBrandStore.pagination.total)
...
const handleEdit = (item: MotherBrand) => {
  router.push({ name: 'mother-brand-edit', params: { id: item.id.toString() } })
}

const confirmDelete = (item: MotherBrand) => {
...
const handleCreate = () => {
  router.push({ name: 'mother-brand-new' })
}
...
const handleExport = async () => {
  ...
  try {
    await motherBrandStore.exportFile(searchQuery.value.trim() || undefined)
            ...
            <VTable>
              ...
              <tbody>
                ...
                <tr v-if="items.length === 0">
                  ...
                  >
                    No mother brands found. Click "Create Mother Brand" to add one.
                  </td>
                </tr>
              </tbody>
            </VTable>
